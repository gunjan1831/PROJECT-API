...
from movielist_app.api.views import (WatchDetailsAV, WatchListAV,StreamPlatformAV,StreamPlatformDetailsAV,ReviewList,
                                        ReviewDetails,ReviewCreate,StreamPlatformVS)
