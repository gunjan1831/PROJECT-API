...
from movielist_app.api.views import WatchDetailsAV, WatchListAV,StreamPlatformAV,StreamPlatformDetailsAV,ReviewList,ReviewDetails
...
urlpatterns = [
    ...
    # path('stream/<int:pk>/review', ReviewDetails.as_view(), name='stream'),
